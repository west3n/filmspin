...
async def movie_by_tmdb(
    ...
    return await service.resolve(lang=lang, tmdb_id=tmdb_id)
...
async def movie_by_kp(
    ...
    return await service.resolve(lang="ru-RU", kp_id=id)
...
async def movie_ru_by_external(
    ...
    return await service.resolve(lang="ru-RU", tmdb_id=tmdb_id, imdb_id=imdb_id)
